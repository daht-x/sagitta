...
const rootConfiguration = {
	rules: {
		...
		"body-max-length": [ruleSeverity.error, ruleCompliance.always, Number.POSITIVE_INFINITY],
		...
		"footer-max-length": [ruleSeverity.error, ruleCompliance.always, Number.POSITIVE_INFINITY],
		...
		"header-trim": [ruleSeverity.error, ruleCompliance.always],
		...
		"type-enum": [ruleSeverity.error, ruleCompliance.always, ["compatibility", "feature", "test", "build", "dependency", "bug", "refactor", "style", "chore", "documentation", "workflow"]],
